 ...
 * `near-willem-workspaces-init` works for the expected range of NodeJS versions and that
 ...
 * dependencies for the `near-willem-workspaces-ava` lookup. This is a truer test that
 * everything works as expected.
 */
const TEST_PROJECT = join(process.cwd(), '../test-near-willem-workspaces-init');
...
(async () => {
  ...
  console.log('Running `near-willem-workspaces-init`');
